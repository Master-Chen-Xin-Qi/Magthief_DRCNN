...
if __name__ == '__main__':
    ...
    for pos_app in CONFIG["app_name"]:
        ...
        # delete_train_his(STN_flag=True, DRCNN_flag=False)
        # stn_trainer.run(train_loader, val_loader, test_loader, pos_app)
        ...
        train_gt, box_labels = stn_trainer.generate_gt_boxes(app_loader, pos_app)
