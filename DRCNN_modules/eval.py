...
'''
@File         : eval.py
@Date         : 2022/06/01 13:55:11
@Author       : Xinqi Chen 
@Software     : VScode
@Description  : evaluation for DRCNN
'''
...
import numpy as np
import six
from DRCNN_modules.bbox_tools import bbox_iou

def eval(dataloader, faster_rcnn, test_num=10000):
    pred_bboxes, pred_labels, pred_scores = list(), list(), list()
    gt_bboxes, gt_labels = list(), list()
    for ii, (imgs, gt_bboxes_, gt_labels_) in tqdm(enumerate(dataloader)):
